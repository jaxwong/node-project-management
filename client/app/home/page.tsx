...
const HomePage = () => {
  ...
  return (
    // FIX 1: Added dark:bg-dark-bg here to fix the white background issue
    <div className="dark:bg-dark-bg container h-full w-full bg-gray-100 p-8">
            ...
            <BarChart data={taskDistribution}>
              ...
              <Tooltip
                contentStyle={{
                  width: "min-content",
                  height: "min-content",
                  // FIX 2: Made tooltip background dynamic
